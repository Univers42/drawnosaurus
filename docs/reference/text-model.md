...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| The text stays selected while it is typed, so the style panel keeps working on it; its frame and handles are not drawn. A style changed meanwhile is written into it and stays with the edit: one step at the commit, nothing stamped before. | deselects everything (`App.tsx@1118751f:6509-6510`)                                                                                  | `ci_text_edit.rs` › painting, peers, style_while_typing; `e2e/textEditor.spec.ts` › a colour picked in the panel; `e2e/fontSize.spec.ts` › one step |
